...
export default  function Home() {
        ...
        // }
          ...
          setProductLoaded(true);
              ...
              await axios.post('http://127.0.0.1:8000/api/admin_varification' , {admin_email : localStorage.getItem('loggedInEmail')});    
                ...
                localStorage.setItem('adminAccess' , 'Not admin'); 
  ...
  useEffect(() => {
    ...
    if(localStorage.getItem('redirectTo') == 'cart'){
      ...
      return (
        <div className="">
          <Container>
            ...
            <div className="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-4 xl:grid-cols-5 2xl:grid-cols-6 gap-4 md:gap-8 pt-4 px-4">
